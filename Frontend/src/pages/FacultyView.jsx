                    ...
                    >
                      ...
                      <td className="sticky right-0 z-10 px-4 py-3 bg-white">
                        <div className="flex items-center justify-center gap-2 opacity-80 transition-opacity group-hover:opacity-100">
                          <button
                            onClick={() => handleOpenLoadingModal(member)}
                            className="rounded-lg border border-slate-200 bg-white p-2 text-slate-500 transition-colors hover:border-transparent hover:bg-green-50 hover:text-green-600"
                            type="button"
                            aria-label={`View faculty loading for ${member.faculty_name}`}
